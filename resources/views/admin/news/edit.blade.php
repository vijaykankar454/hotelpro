...
<div class="content-header">
  <div class="container-fluid">
    <div class="row mb-2">
      <div class="col-sm-6">
        <h1 class="m-0 text-dark">{{ __('Edit News') }}</h1>
      </div><!-- /.col -->
      <div class="col-sm-6">
    ...
    <div class="row" >
      ...
      <div class="col-md-12">
        ...
        <div class="card card-primary">
          ...
          <!-- /.card-header -->
          <!-- form start -->
          {!! Form::model($News,['method'=>'PATCH', 'url'=> route('admin.news.recupdate',$News->id), 'files' => true,'name'=>'edit_news', 'id'=>'edit_news','novalidate'=>'novalidate']) !!}
          {!! Form::hidden('id', null)!!}
          <div class="card-body col-md-8" >
            ...
            @if($News->photo)
            <img height="67" src="{{$News->photo}}" alt="">
            @endif
            <br>
            <div class="form-group">
            ...
            @if($News->banner)
            <img height="120" src="{{$News->banner}}" alt="">
            @endif
            <br>
